...
// [0] - Сумма положительных элементов
// [1] - Сумма отрицательных элементов
int[] sumPositiveNegativeElem = GetSumPositiveNegativeElem(arr);
Console.Write($"Сумма положительных элементов = {sumPositiveNegativeElem[0]}, сумма отрицательных элементов = {sumPositiveNegativeElem[1]} ");