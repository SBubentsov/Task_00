...
int[,] MatrixComposition(int[,] matr1,int[,] matr2)
{ 
...
Console.WriteLine($"Программа создает два двумерных массива cо случайным количеством строк и столбцов и находит произведение этих массивов");
...
{
int[,] matrixComposition = MatrixComposition(matrix1,matrix2);
Console.WriteLine("Результирующая матрица:");
PrintMatrix(matrixComposition);
}